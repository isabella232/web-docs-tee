...
<img src={require('../../assets/etcher.png').default} alt="drawing" width="640" />

1. Select the image
2. Select the output device where your SD is located
3. Click Flash

<img src={require('../../assets/etcher2.png').default} alt="drawing" width="640" />

4. Wait until the process finishes.

5. Done!! :tada:

<img src={require('../../assets/etcher3.png').default} alt="drawing" width="640" />
