...
:::note Using tabs could be useful
:::

:::note 
Normal Markdown seems to not work inside table sections????
:::

<Tabs>
    <TabItem value="dk2" label="STM32MP157F-DK2" default>
        ```bash
        echo "NO BASH CODE SECTION??"
        ```
    </TabItem>
    <TabItem value="iMX8MM" label="8MMINILPD4-EVKB">
        Content for 8MMINILPD4-EVKB
    </TabItem>
    <TabItem value="iMX8M-Mini" label="SBC-iMX8M-Mini">
        Content for SBC-iMX8M-Mini
    </TabItem>
</Tabs>
...
through __tcp://localhost:39946__, check [docs](../testing/intro.md) to know how to ensure
