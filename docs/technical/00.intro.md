...
[Hello RusTee](./40.Development/40.HelloRustee.md) demonstrates how we can run both a host and trusted apps using OPTEE and Rust in these devices.
...
If you are interested, more information about the process, tooling and testing can be found [here](./40.Development/40.HelloRustee.md)
:::
